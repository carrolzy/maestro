...
def _tool_definitions() -> list[JsonDict]:
    return [
        ...
        _tool_schema(
            "register_project",
            "Register a new project shell in the local AI efficiency system.",
            {
                "project": {"type": "string"},
                "summary": {"type": "string"},
        ...
        _tool_schema(
            ...
            "Write a markdown note into Obsidian and sync it into project memory.",
            {
                "vault_root": {"type": "string"},
                "note_path": {"type": "string"},
                "project": {"type": "string"},
...
def _tool_schema(name: str, description: str, properties: JsonDict, required: list[str] | None = None) -> JsonDict:
    return {
        "name": name,
